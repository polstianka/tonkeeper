    ...
    constructor(
        ...
        fun contentMatchParent() {
            titleView.layoutParams =
                titleView.layoutParams.apply {
                    width = ViewGroup.LayoutParams.MATCH_PARENT
                }
            subtitleContainerView.layoutParams =
                subtitleContainerView.layoutParams.apply {
                    width = ViewGroup.LayoutParams.MATCH_PARENT
                }
            subtitleView.layoutParams =
                subtitleView.layoutParams.apply {
                    width = ViewGroup.LayoutParams.MATCH_PARENT
                }
        }
        ...
        fun setSubtitle(text: CharSequence?) {
            withAnimation(duration = ANIMATION_DURATION) {
                subtitleContainerView.visibility =
