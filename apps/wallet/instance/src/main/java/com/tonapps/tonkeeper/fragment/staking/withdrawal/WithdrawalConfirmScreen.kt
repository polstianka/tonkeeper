...
class WithdrawalConfirmScreen : BaseFragment(R.layout.fragment_stake_confirm) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        actionTitle.setText(Localization.unstake)
        ...
        sendButton.doOnDone = {
            withdrawalScreenViewModel.send(requireContext())
        }
        processView = view.findViewById(R.id.process)

        collectFlow(withdrawalScreenViewModel.transactionEmulationFlow) { emulation ->
        ...
        collectFlow(withdrawalScreenViewModel.transactionSender.statusFlow) { state ->
    ...
    companion object {
        fun newInstance() = WithdrawalConfirmScreen()
    }
}