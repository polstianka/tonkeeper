...
val koinModel = module {
    ...
    viewModel { WalletViewModel(get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get()) }
    ...
    viewModel { StakeViewModel(get(), get(), get(), get(), get(), get()) }
    ...
    viewModel { PickAssetViewModel(get(), get(), get()) }
