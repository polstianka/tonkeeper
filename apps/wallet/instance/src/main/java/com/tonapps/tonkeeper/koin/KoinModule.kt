...
import com.tonapps.tonkeeper.dialog.trade.operator.ChooseOperatorViewModel
import com.tonapps.tonkeeper.dialog.trade.operator.confirmation.ConfirmationTradeViewModel
...
val koinModel =
    module {
        ...
        viewModel { ChooseOperatorViewModel(get(), get()) }
        viewModel { ConfirmationTradeViewModel() }
    }
