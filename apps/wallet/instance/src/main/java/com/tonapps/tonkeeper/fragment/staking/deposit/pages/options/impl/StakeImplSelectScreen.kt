package com.tonapps.tonkeeper.fragment.staking.deposit.pages.options.impl
...
class StakeImplSelectScreen : BaseFragment(R.layout.fragment_stake_pool_selector_page) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        collectFlow(poolsViewModel.implementationUiItemsFlow, adapter::submitList)
    }

    companion object {
        fun newInstance() = StakeImplSelectScreen()
    }
}